...
('Martín', 'Herrera', 'Gerente', '3511111111', 'martin.herrera@hoteldb.com', '2018-03-01', 1),
('Sofía', 'Castro', 'Recepcionista', '3512222222', 'sofia.castro@hoteldb.com', '2020-06-15', 1),
('Lucas', 'Pereyra', 'Recepcionista', '3513333333', 'lucas.pereyra@hoteldb.com', '2021-01-10', 1),
('Romina', 'Díaz', 'Mucama', '3514444444', NULL, '2019-09-20', 1),
('Fernando', 'Rojas', 'Mantenimiento', '3515555555', 'fernando.rojas@hoteldb.com', '2017-11-05', 1),
('Gabriel', 'Molina', 'Mantenimiento', '3516666666', NULL, '2022-04-01', 1),
('Carolina', 'Vega', 'Conserje', '3517777777', 'carolina.vega@hoteldb.com', '2023-02-14', 1),
('Ricardo', 'Paz', 'Recepcionista', '3518888888', 'ricardo.paz@hoteldb.com', '2024-08-01', 0);

INSERT INTO Estados (EstadoNombre, Tabla) VALUES
('Disponible', 'Habitaciones'),
('Ocupada', 'Habitaciones'),
('En Mantenimiento', 'Habitaciones'),
('Pendiente', 'Reservas'),
('Confirmada', 'Reservas'),
('En Curso', 'Reservas'),
('Finalizada', 'Reservas'),
...
INSERT INTO Habitaciones (numero, piso, id_tipo_habitacion, id_estadoHabitacion) VALUES
(101, 1, 1, 1),
(102, 1, 1, 1),
(103, 1, 1, 1),
(104, 1, 1, 2),
...
INSERT INTO Reservas (id_huesped, id_habitacion, fecha_checkin, fecha_checkout, Id_EstadoReserva, fecha_reserva, observaciones) VALUES
(1, 4,  '2026-05-20', '2026-05-25', 6, '2026-05-10', 'Solicita almohada extra'),
(2, 6,  '2026-05-22', '2026-05-28', 6, '2026-05-15', NULL),
(3, 13, '2026-05-25', '2026-05-30', 6, '2026-05-18', 'Llegada tarde, después de las 22hs'),
(4, 25, '2026-05-28', '2026-06-02', 6, '2026-05-20', NULL),
(5, 40, '2026-05-29', '2026-06-03', 6, '2026-05-22', 'Aniversario, pide decoración'),
(6, 1,  '2026-06-05', '2026-06-08', 5, '2026-05-25', NULL),
(7, 9,  '2026-06-10', '2026-06-15', 5, '2026-05-28', 'Viaja con mascota'),
(8, 20, '2026-06-12', '2026-06-14', 5, '2026-05-30', NULL),
(9, 39, '2026-06-15', '2026-06-20', 5, '2026-06-01', 'Requiere estacionamiento'),
(10, 5, '2026-04-10', '2026-04-15', 7, '2026-04-01', NULL),
(1, 8,  '2026-03-01', '2026-03-05', 7, '2026-02-20', NULL),
(3, 30, '2026-04-20', '2026-04-22', 8, '2026-04-10', 'Canceló por motivos personales');
...
INSERT INTO Facturas (id_reserva, fecha_emision, total_alojamiento, total_consumos, total, metodo_pago, id_estadoFactura) VALUES
(10, '2026-04-15', 275000.00, 26500.00, 301500.00, 'Tarjeta Crédito', 10),
(11, '2026-03-05', 220000.00, 22000.00, 242000.00, 'Efectivo', 10);
